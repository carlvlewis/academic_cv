...
\usepackage[xetex, bookmarks, colorlinks, breaklinks, pdftitle={Karl Pichotta CV},pdfauthor={Karl Pichotta}]{hyperref} % PDF setup - set your name and the title of the document to be incorporated into the final PDF file meta-information
...
\years{2014} Google, PhD Intern. \\
\phantom{xxxx} Machine Learning for acquisition of commonsense 
knowledge. \\

\years{2012} Google, PhD Intern. \\
\phantom{xxxx} Machine Learning to identify idiomaticity in language. \\

\years{2008--2010} Versay Solutions, Software Engineer.\\
\phantom{xxxx} \mbox{Voice interfaces; Natural Language Processing for 
application analytics.} \\

\years{2008}SRI Artificial Intelligence Center, Student Associate.\\
\phantom{xxxx} Automatic text summarization. \\

\years{2007}PARC (Palo Alto Research Center) Natural Language Theory and Technology Group, Research Intern. \\
\phantom{xxxx} Implementation of certain classes of textual entailment in 
large NLP system. \\

\years{2006}Stanford University Electrical Engineering Department, Research Assistant. \\
\phantom{xxxx} Automatic detection of lightning events from atmospheric data. \\

\years{2005} Motorola, Intern. \\
\phantom{xxxx} Radio network infrastructure software engineering. \\

\years{2004} Motorola, Intern. \\
\phantom{xxxx} Large-scale simulation of communications infrastructure.
...
%\years{2014} Co-coordinator, Methods and Algorithms with Priors (MAP) reading group, on Bayesian methods in Machine Learning..\\
%\years{2012--2014} Coordinator, Forum for Artificial Intelligence lecture series.\\
%\years{2012} Coordinator, Deep Exploration and Filtering of Text (DEFT) reading group.\\
%\years{2011} Coordinator, Machine Reading Project (MRP) reading group.
